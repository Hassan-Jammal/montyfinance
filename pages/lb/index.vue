    ...
    <section id="section-2" class="about-us py-16 md:py-32 text-center mx-auto">
        <div class="container">
            <div class="w-full md:w-3/5 mx-auto">
                ...
                <p class="mt-6 text-base text-[#73788B]" data-aos="fade-up">Monty Finance SAL is a licensed financial institution authorized by the Central Bank of Lebanon, holding an e-wallet license. Through our innovative application, MyMonty, users can effortlessly open accounts, manage their finances, perform transactions, and explore a variety of payment options tailored to meet their needs. MyMonty offers a comprehensive suite of features and products designed to unlock opportunities and enhance financial convenience.<br /><br />At Monty Finance SAL, we are committed to fostering trust, driving financial inclusion, and delivering tools that empower our community for a better financial future.</p>
            </div>
        ...
        <div class="container">
            ...
            <div class="w-full md:w-4/5 mx-auto flex max-md:flex-col justify-center items-center gap-7 md:gap-24 mt-24">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <p class="mt-6 text-base text-[#73788B]" data-aos="fade-up">At Monty Finance SAL, we firmly believe that access to financial services is a fundamental right. Leveraging our team's local and international experience and  expertise, built over decades in leading financial and consulting firms, we are dedicated to developing tailored financial solutions that address the unique needs and challenges of the Lebanese community.</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div v-for="(item, index) in otherItems" :key="item.id" class="backgroundBlur grid grid-cols-2 gap-4 rounded-xl p-6 cursor-pointer">
                        ...
                        <div class="flex flex-col justify-between py-6">
                            ...
                            <ScrollButton target="board" class="readMore flex items-center gap-2 text-base text-[#DFDFE0] hover:text-[#09052B] cursor-pointer" @click="swapItems(index)">
                                <p>Read More</p>
                                <svg width="25" height="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7 17L17 7M17 7H7M17 7V17" stroke="#FFFFFF" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </ScrollButton>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col justify-center items-stretch gap-8">
                        <div class="flex-1 p-6 md:p-12 bg-gray-100">
                            <div class="flex items-start gap-4" data-aos="fade-up">
                                ...
                                <div>
                                    <h2 class="mt-2 text-3xl text-[#585E8D] font-lora">Head Office Address</h2>
                                    <p class="block mt-2 text-[#73788B]">Gefinor Center, Clemenceau Street, Hamra, Beirut, Lebanon</p>
                                </div>
                            </div>
                        </div>
                        <div class="flex-1 p-6 md:p-12 bg-gray-100">
                            <div class="flex items-start gap-4" data-aos="fade-up">
                                ...
                                <div>
                                    <h2 class="mt-2 text-3xl text-[#585E8D] font-lora">Contact Information</h2>
                                    <a href="tel:+448082387522" class="block mt-2 text-[#73788B]">Call Center: +961 1 734 020 <br />WhatsApp: +961 71 871 871</a>
                                </div>
                            </div>
                        </div>
                        <div class="flex-1 p-6 md:p-12 bg-gray-100">
                            <div class="flex items-start gap-4" data-aos="fade-up">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:info@montyfinance.coms" class="block mt-2 text-[#73788B]">info@montyfinance.com</a>
                                </div>
                            </div>
                        </div>
