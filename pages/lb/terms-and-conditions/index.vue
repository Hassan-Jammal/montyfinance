<template>
    <div class="container bg-[#F8F6F8] p-8 md:p-12 rounded-xl flex flex-col gap-4 my-32">
        ...
        <h2 class="font-lora font-bold text-2xl">1. INFORMATION ABOUT US</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">2. SCOPE</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">3. AGREEMENT TO T&Cs</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">4. CHANGES TO THESE T&Cs</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">5. CHANGES TO OUR WEBSITE</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">6. COPYRIGHT</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">7. TRADEMARKS</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">8. SUBMISSIONS</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">9. DISCLOSURE; FORWARD-LOOKING STATEMENTS</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">10. THIRD PARTY SERVICES OR PRODUCTS ON OUR WEBSITE</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">11. LINKS TO THIRD PARTY SITES</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">12. NO OFFER OR ADVICE</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">13. DATA PROTECTION</h2>

        Use by Us of any personal data which You submit via Our Website is described on and subject to our Data
        Protection Policy.

        <h2 class="font-lora font-bold text-2xl">14. COOKIES</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">15. DISCLAIMER AND LIMITATION OF LIABILITY</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">16. INDEMNITY</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">17. NO WAIVER</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">18. SEVERANCE</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">19. EXCLUSION OF THIRD-PARTY RIGHTS</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">20. ENTIRE AGREEMENT</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">21. GOVERNING LAW AND JURISDICTION</h2>
