<template>
    <div class="container bg-[#F8F6F8] p-8 md:p-12 rounded-xl flex flex-col gap-4 my-32">
        ...
        <h2 class="font-lora font-bold text-2xl">1. INTRODUCTION</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">2. WHAT IS PERSONAL DATA, PROCESSING, AND SENSITIVE PERSONAL DATA?</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">3. OUR DATA PROTECTION PRINCIPLES</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">4. WHAT ARE YOUR RIGHTS AS A DATA SUBJECT?</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">5. HOW IS DATA COLLECTED AND PROCESSED?</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">6. WHAT IS THE LEGAL BASIS FOR COLLECTING AND PROCESSING PERSONAL DATA?
        </h2>
        ...
        <h2 class="font-lora font-bold text-2xl">7. HOW DOES THE PERSONAL DATA FLOWS AND WHO DO WE SHARE IT WITH?</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">8. WHAT CAN YOU DO TO HELP US KEEP YOUR DATA SAFE?</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">9. HOW DO WE STORE YOUR PERSONAL DATA AND FOR HOW LONG?</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">10. HOW DO WE PROTECT YOUR PERSONAL DATA?</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">11. SAFEGUARDS IN PLACE TO PROTECT YOUR PERSONAL DATA</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">12. WHO TO CONTACT IN RELATION WITH PERSONAL DATA PROTECTION?</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">13. COMPLAINTS</h2>
        ...
        <h2 class="font-lora font-bold text-2xl">14. CHANGES TO THIS POLICY</h2>
...
useSeoMeta({
    ...
    ogTitle: 'Data Protection Policy',
    ogDescription: '',
    ogImage: '/assets/images/share-image-team.webp',

    twitterTitle: 'Data Protection Policy',
    twitterDescription: '',
