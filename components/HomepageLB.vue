...
<script setup>
    ...
    const allItems = ref([
        ...
        },
        {
            ...
            role: 'Board Member',
            linkedin: '#',
            description: 'George Kanaan is an executive with an impressive career in finance and asset management. His career spans extensive leadership in financial institutions, including Citibank and First National Bank of Chicago, underscoring his expertise in driving financial growth and innovation. As the Chief Executive Officer of the Arab Bankers Association in London since 2009, he has expertly managed all aspects of the association’s activities. His prior roles include leading Resource Consolidated Limited, advising on real estate finance and investments, and serving as CEO of Makshaff Services Limited, where he managed over $1.5 billion in global assets. George also built Citibank’s London branch from inception, achieving market leadership and profitability, and played a pivotal role in establishing Samba Capital Management International.',
        },
        {
            id: 3,
            ...
            role: 'Board Member',
            linkedin: '#',
            description: 'Walter W. Sioufi is a financial executive with a broad range of expertise across various regions and sectors. His extensive experience includes leading the Millennium Challenge Corporation’s $450 million grant initiative in Morocco, managing Citibank Maghreb’s operations across Morocco, Tunisia, and Libya, and holding senior roles at Citibank and American Express in Beirut and globally. Walter’s early career included significant positions at SGI Eurofinance and the Royal Bank of Canada, where he gained deep insights into structured finance and international banking. His leadership extends to various CSR engagements, including prominent roles with the American Chamber of Commerce and Endeavor Morocco. Currently, he serves as the Independent Non-Executive Chairman of the Board at Bank of Africa UK Plc, overseeing board governance and regulatory relations. Previously, he was an Independent Board Member and Chairman of the Audit Committee at Attijariwafa Bank Egypt, where he enhanced financial oversight and controls.',
        },
        {
            id: 4,
            image: '/images/gaby-andari.png',
            ...
            role: 'Board Member',
            linkedin: '#',
            description: 'Gaby Andari is an IT executive with a remarkable track record in digital transformation and strategic IT leadership. As Chief Information Officer at Bank of Beirut, he has spearheaded global IT and business digital transformation initiatives, overseeing a team of over 120 IT professionals across multiple regions including Lebanon, Australia, Oman, the UK, and Cyprus. Previously, as Vice President at Canadian Scholarship Trust Plan, Gaby led a major IT infrastructure overhaul, achieving a dramatic increase in system uptime and delivering key business transformation projects. He has driven significant advancements in IT governance, cloud infrastructure, and digital solutions, ensuring robust security, modernized back-office systems, and enhanced client onboarding through AI and robotics. Gaby’s experience extends to strategic roles at Boston Acoustics, Perseptive Biosystems, and Millipore, where he successfully implemented major ERP systems, optimized IT operations, and managed global technology infrastructures.',
        },
    ]);
